...
import { Modal, Input, Form, Row, Col, Cascader, Radio, Select } from 'antd'
      ...
      case 'update':
        {
          form.setFieldsValue({
            ...
            supervisors: record.supervisors.map(v => v.userId),
          })
        }
        break
    }
        ...
        <Row>
          ...
          <Col span={12}>
            <Form.Item
              ...
              rules={[
                { required: false },
                // { pattern: /^[0-9]{1,10}$/, message: '请输入10位以内的数字' },
              ]}
            >
          ...
          <Col span={12}>
            <Form.Item
              name="supervisors"
              label="监管员"
              rules={[{ required: true, message: '监管员为必填项' }]}
            >
              <Select
                mode="multiple"
                allowClear
